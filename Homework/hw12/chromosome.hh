...
class Chromosome {
 ...
 public:
  ...
  // Implemented function to switch the values of different indices within order_
  // for ClimbChromosome class mutate method
  virtual void swapVal(int num1, int num2);
