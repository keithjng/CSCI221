...
{
  unsigned i = 0, j = 0; // Set i and j as integers that will be used as counters
  double pi = 0, inside = 0, total = 0; // Establish pi as a variable with decimal points that will be the estimate of pi, distance will be the distance of a gridpoint from (0, 0). Inside will be used to count the number of gridpoints inside the circle, total counts the total number of gridpoints
...
int main()
{
  ...
  gp = gridpi2(n); // Call the gridpi helper function
